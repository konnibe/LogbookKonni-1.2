...
enum FORMAT {HTML,ODT};
		...
		wxCheckBox* m_checkBoxMain1;
		wxCheckBox* m_checkBoxGenoa1;
		wxCheckBox* m_checkBoxGenoa2;
		wxCheckBox* m_checkBoxGenoa3;
		wxCheckBox* m_checkBoxFock1;
		wxCheckBox* m_checkBoxFock2;
		wxCheckBox* m_checkBoxFock3;
		wxCheckBox* m_checkBoxJib;
		wxCheckBox* m_checkBoxMizzen;
		wxCheckBox* m_checkBoxMizzen1;
		wxCheckBox* m_checkBoxStaysail;
		wxCheckBox* m_checkBoxSpinacker;
